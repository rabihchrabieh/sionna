...
class LDPC5GEncoder(Block):
    ...
    n: int
        Defining the desired codeword length (first transmission).
    ...
    the 5G encoding scheme. Optionally, rate matching is applied externally.
    ...
    @property
    def n_cb(self):
        """Circular buffer length for HARQ (excluding filler bits)."""
